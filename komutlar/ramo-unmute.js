...
const mutelog = message.guild.channels.cache.find(c => c.id === '792047442291720224')//Mute log
const muterol = message.guild.roles.cache.find(r => r.id === '791378260167622707')//Muteli rolü
