...
client.on("message", message => {
    ...
    return message.channel.send(`https://www.twitch.tv/hocako`)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "!!youtube") 
    return message.channel.send(`https://www.youtube.com/channel/UC-MYXyeP6bsrFdj8HlvebZQ`)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "!!instagram") 
    return message.channel.send(`https://www.instagram.com/hocakogram`)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "!!steam") 
    return message.channel.send(`https://steamcommunity.com/groups/hocako`)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "!!discord") 
    return message.channel.send(`https://discord.gg/MWWuZFZzZt`)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "!!tag") 
    return message.channel.send(`<isim>KO ;)`)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "!!çekiliş") 
    return message.channel.send(`<#791917897161244682> Kanalına Göz Atabilirsin.. ;)`)
});
...
client.on("message", message => {
    ...
    return message.channel.send(`${message.author} AsKO Canım. <a:elmas:791583923443728434> `)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "saKO") 
    return message.channel.send(`${message.author} AsKO Canım. <a:elmas:791583923443728434> `)
});
...
client.on("message", message => {
    ...
    return message.channel.send(`${message.author} SelamKo hoşgeldin. <a:elmas:791583923443728434> `)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "merhaba") 
    return message.channel.send(`${message.author}, MerhabaKo hoşgeldin. <a:elmas:791583923443728434> `)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "hocako") 
    return message.channel.send(`Dolardan Hızlı Yükseliyoruz desem?`)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "hoko") 
    return message.channel.send(`${message.author} HoKO Reislerr.. <a:heyyp:790229229387644968> `)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "mrb") 
    return message.channel.send(`${message.author} MrbKo. <a:elmas:791583923443728434> `)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "slm") 
    return message.channel.send(`${message.author} slmKo <a:elmas:791583923443728434> .`)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "destek") 
    return message.channel.send(`${message.author} Destek Talebi Almak için <@&779615971358015508> Ve <@&779619156697677844> Kişilerine Ulaşınız.`)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "yayın ne zaman") 
...
client.on("message", message => {
    if(message.content.toLowerCase() == "stok") 
    return message.channel.send(`${message.author} Stoklar Hakkında Bilgi almak için <#785960064115539998> Bakınız.`)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "KO") 
    return message.channel.send(`${message.author} D-dostum Yoksa Bize Mi Katılıcaksın..`)
});
...
client.on("message", message => {
    if(message.content.toLowerCase() == "hgko") 
    return message.channel.send(`${message.author} Owwww Burda Yenilerden Birisi mi varrrr HgKo..`)
  });


client.on("message", message => {
    if(message.content.toLowerCase() == "EzgiKO") 
    return message.channel.send(`https://cdn.glitch.com/c9d6d228-4866-41dc-b291-0d65a6e0f877%2Fsj.webp?v=1609152164055`)
  });
//------------------------------------------------------------------------------------------------------------\\
...
client.on("message" , async msg => {
 ...
 if(afk){
  ...
  if(msg.author.id === kisi){
       ...
       msg.channel.send(new Discord.MessageEmbed().setColor('BLACK').setDescription(`<@${kisi}> Başarıyla Afk Modundan Çıktınız. <a:qwe:790224601447399445> `))
